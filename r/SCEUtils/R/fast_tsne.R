# This a copy of the file at:
# /home/nfox.local/bin/FIt-SNE/fast_tsne.R
# and is edited to more neatly function in this package.
# If the package is recompiled, this file should be updated.

FAST_TSNE_SCRIPT_DIR <<- "/home/nfox/.local/bin/FIt-SNE/bin/fast_tsne"
